...
## Scope
The scope of this project is to create a webchat legal triage and first line advice.

## Stakeholders
Below are the relevant stakeholders, detailed explaination can be found in [stakeholder-register](stakeholder-register.md):
* Client
* Legal Advisor
* Supervisor
* Administrator
...
* No way to take payments over the system 
* Demo-and-teardown model only
